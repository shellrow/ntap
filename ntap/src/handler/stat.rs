...
pub fn show_stat_default(app: &ArgMatches) -> Result<(), Box<dyn Error>> {
...
pub fn show_stat(app: &ArgMatches) -> Result<(), Box<dyn Error>> {
    let sub_args = match app.subcommand_matches("stat") {
